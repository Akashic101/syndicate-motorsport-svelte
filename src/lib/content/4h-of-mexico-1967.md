<h1 class="text-center">GTR vs. 70's TCL: 4h of Mexico 1967</h1>

![4h of Mexico – Syndicate Motorsport GTR vs TCL Poster](/api/storage-image?bucket=poster&key=2026-02-08-Syndicate-Motorsport-gtr-vs-tcl-Poster.jpg)
...
- [Custom Shader Patch (CSP)](https://acstuff.club/patch/) version 0.2.11 or newer
- [Real Penalty](https://www.patreon.com/file?h=92150073&m=242828576) (manual installation required: necessary for Driver Swap & Penalty handling)

## Cars

- 70s TCL: https://thracing.de/touring-car-legends/
- ACL GTR: https://thracing.de/ac-legends-gt-classics-by-bazza/

## Circuit

- https://www.overtake.gg/downloads/mexico-gran-premio-1967-redux.66405/

---

# Optional but recommended apps

- [Blinker Sound App](https://www.overtake.gg/downloads/blinker-sound-app.64886/)
- [Dashboard Indicators](https://www.overtake.gg/downloads/dashboard-indicators.72636/)
...
To ensure a proper installation, Real Penalty must be installed manually. _Do not install it through Content Manager._
...
_CSP → Extra FX: Disable this option_: (Extra FX adds an additional rendering pass for visual enhancements and is very demanding on performance.)

_CSP → Graphic Adjustments_: Enable AMD FidelityFX Super Resolution. Using a slightly reduced quality value (around 77%) can significantly boost framerate—even on NVIDIA GPUs.

_CSP modules_: Consider turning off any non-essential CSP features to improve performance. However, always keep Weather FX, Car Instruments, Graphic Adjustments, and Lighting FX enabled.

_Assetto Corsa → Video settings_: Use a performance-focused preset. For example, lower the resolution of shadows, reflections, and mirrors, and reduce the World Detail level.
...
![circuit](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Autodromo_Hermanos_Rodriguez_1963.svg/1920px-Autodromo_Hermanos_Rodriguez_1963.svg.png)
...
![original footage](/api/storage-image?bucket=general_images&key=mexico_1967_footage.jpg)

## Event Schedule

- Practice is running 24/7
- Quali and test-race details will be announced soon

...
export function getChampionshipOGData(
	championship: any,
	baseUrl: string = 'https://syndicate-motorsport.com'
) {
	...
	return generateOpenGraphTags(
		{
			...
			description:
				...
				`Join the ${championship.name} championship at Syndicate Motorsport. Professional sim racing competition.`,
			image: imageUrl,
	...
	return generateOpenGraphTags(
		{
			...
			description:
				'View the fastest lap times and records set by Syndicate Motorsport drivers across various tracks and championships.',
	...
	return generateOpenGraphTags(
		{
			...
			description:
				'Discover upcoming events, championships, and leagues at Syndicate Motorsport. Join competitive sim racing competitions.',
	...
	return generateOpenGraphTags(
		{
			...
			description:
				'Support Syndicate Motorsport through Patreon, join our Discord community, and help us grow our sim racing platform.',
